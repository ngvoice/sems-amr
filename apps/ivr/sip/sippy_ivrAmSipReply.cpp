...
static void *init_AmSipReply(sipWrapper *,PyObject *sipArgs,int *)
{
	...
	if (!sipCpp)
	{
		sipNoCtor(sipArgsParsed,sipNm_py_ivr_AmSipReply);
		return 0;
	}
...
static PyObject *var_AmSipReply_cseq(PyObject *sipSelf,PyObject *valobj)
{
	...
	{
		sipBadSetType(sipNm_py_ivr_AmSipReply,sipNm_py_ivr_cseq);
		return NULL;
	}
...
static PyObject *var_AmSipReply_local_tag(PyObject *sipSelf,PyObject *valobj)
{
	...
	if (iserr)
	{
		sipBadSetType(sipNm_py_ivr_AmSipReply,sipNm_py_ivr_local_tag);
		return NULL;
	}
...
static PyObject *var_AmSipReply_remote_tag(PyObject *sipSelf,PyObject *valobj)
{
	...
	if (iserr)
	{
		sipBadSetType(sipNm_py_ivr_AmSipReply,sipNm_py_ivr_remote_tag);
		return NULL;
	}
...
static PyObject *var_AmSipReply_body(PyObject *sipSelf,PyObject *valobj)
{
	...
	if (iserr)
	{
		sipBadSetType(sipNm_py_ivr_AmSipReply,sipNm_py_ivr_body);
		return NULL;
	}
...
static PyObject *var_AmSipReply_hdrs(PyObject *sipSelf,PyObject *valobj)
{
	...
	if (iserr)
	{
		sipBadSetType(sipNm_py_ivr_AmSipReply,sipNm_py_ivr_hdrs);
		return NULL;
	}
...
static PyObject *var_AmSipReply_route(PyObject *sipSelf,PyObject *valobj)
{
	...
	if (iserr)
	{
		sipBadSetType(sipNm_py_ivr_AmSipReply,sipNm_py_ivr_route);
		return NULL;
	}
...
static PyObject *var_AmSipReply_next_hop(PyObject *sipSelf,PyObject *valobj)
{
	...
	if (iserr)
	{
		sipBadSetType(sipNm_py_ivr_AmSipReply,sipNm_py_ivr_next_hop);
		return NULL;
	}
...
static PyObject *var_AmSipReply_next_request_uri(PyObject *sipSelf,PyObject *valobj)
{
	...
	if (iserr)
	{
		sipBadSetType(sipNm_py_ivr_AmSipReply,sipNm_py_ivr_next_request_uri);
		return NULL;
	}
...
static PyObject *var_AmSipReply_reason(PyObject *sipSelf,PyObject *valobj)
{
	...
	if (iserr)
	{
		sipBadSetType(sipNm_py_ivr_AmSipReply,sipNm_py_ivr_reason);
		return NULL;
	}
...
static PyObject *var_AmSipReply_code(PyObject *sipSelf,PyObject *valobj)
{
	...
	if (PyErr_Occurred() != NULL)
	{
		sipBadSetType(sipNm_py_ivr_AmSipReply,sipNm_py_ivr_code);
		return NULL;
	}
...
PyMethodDef variables_AmSipReply[] = {
	{sipNm_py_ivr_cseq, var_AmSipReply_cseq, 0, NULL},
	{sipNm_py_ivr_local_tag, var_AmSipReply_local_tag, 0, NULL},
	{sipNm_py_ivr_remote_tag, var_AmSipReply_remote_tag, 0, NULL},
	{sipNm_py_ivr_body, var_AmSipReply_body, 0, NULL},
	{sipNm_py_ivr_hdrs, var_AmSipReply_hdrs, 0, NULL},
	{sipNm_py_ivr_route, var_AmSipReply_route, 0, NULL},
	{sipNm_py_ivr_next_hop, var_AmSipReply_next_hop, 0, NULL},
	{sipNm_py_ivr_next_request_uri, var_AmSipReply_next_request_uri, 0, NULL},
	{sipNm_py_ivr_reason, var_AmSipReply_reason, 0, NULL},
	{sipNm_py_ivr_code, var_AmSipReply_code, 0, NULL},
	{0, 0, 0, 0}
};
...
static void *forceConvertTo_AmSipReply(PyObject *valobj,int *iserrp)
{
	...
	sipBadClass(sipNm_py_ivr_AmSipReply);
