...
{
	extern void sipVH_py_ivr_1(sip_gilstate_t,PyObject *,const AmSipRequest&);

	sip_gilstate_t sipGILState;
	PyObject *meth;

	meth = sipIsPyMethod(&sipGILState,&sipPyMethods[0],sipPySelf,NULL,sipNm_py_ivr_onInvite);
	...
	sipVH_py_ivr_1(sipGILState,meth,a0);
}
...
void sipIvrDialog::onSessionStart(const AmSipRequest& a0)
{
	...
	meth = sipIsPyMethod(&sipGILState,&sipPyMethods[1],sipPySelf,NULL,sipNm_py_ivr_onSessionStart);
...
void sipIvrDialog::onBye(const AmSipRequest& a0)
{
	...
	meth = sipIsPyMethod(&sipGILState,&sipPyMethods[2],sipPySelf,NULL,sipNm_py_ivr_onBye);
...
{
	extern void sipVH_py_ivr_3(sip_gilstate_t,PyObject *);

	sip_gilstate_t sipGILState;
	PyObject *meth;

	meth = sipIsPyMethod(&sipGILState,&sipPyMethods[3],sipPySelf,NULL,sipNm_py_ivr_onCancel);
	...
	sipVH_py_ivr_3(sipGILState,meth);
}

void sipIvrDialog::onDtmf(int a0,int a1)
{
	extern void sipVH_py_ivr_2(sip_gilstate_t,PyObject *,int,int);

	sip_gilstate_t sipGILState;
	PyObject *meth;

	meth = sipIsPyMethod(&sipGILState,&sipPyMethods[4],sipPySelf,NULL,sipNm_py_ivr_onDtmf);
	...
	sipVH_py_ivr_2(sipGILState,meth,a0,a1);
}
...
void sipIvrDialog::onOtherBye(const AmSipRequest& a0)
{
	...
	meth = sipIsPyMethod(&sipGILState,&sipPyMethods[5],sipPySelf,NULL,sipNm_py_ivr_onOtherBye);
...
{
	extern void sipVH_py_ivr_0(sip_gilstate_t,PyObject *,const AmSipReply&);

	sip_gilstate_t sipGILState;
	PyObject *meth;

	meth = sipIsPyMethod(&sipGILState,&sipPyMethods[6],sipPySelf,NULL,sipNm_py_ivr_onOtherReply);
	...
	sipVH_py_ivr_0(sipGILState,meth,a0);
}
...
static PyObject *meth_IvrDialog_acceptAudio(PyObject *sipSelf,PyObject *sipArgs)
{
	...
	sipNoMethod(sipArgsParsed,sipNm_py_ivr_IvrDialog,sipNm_py_ivr_acceptAudio);
...
static PyObject *meth_IvrDialog_setStopped(PyObject *sipSelf,PyObject *sipArgs)
{
	...
	/* Raise an exception if the arguments couldn't be parsed. */
	sipNoMethod(sipArgsParsed,sipNm_py_ivr_IvrDialog,sipNm_py_ivr_setStopped);
...
static PyObject *meth_IvrDialog_onInvite(PyObject *sipSelf,PyObject *sipArgs)
{
	...
	/* Raise an exception if the arguments couldn't be parsed. */
	sipNoMethod(sipArgsParsed,sipNm_py_ivr_IvrDialog,sipNm_py_ivr_onInvite);
...
static PyObject *meth_IvrDialog_onSessionStart(PyObject *sipSelf,PyObject *sipArgs)
{
	...
	/* Raise an exception if the arguments couldn't be parsed. */
	sipNoMethod(sipArgsParsed,sipNm_py_ivr_IvrDialog,sipNm_py_ivr_onSessionStart);
...
static PyObject *meth_IvrDialog_onBye(PyObject *sipSelf,PyObject *sipArgs)
{
	...
	/* Raise an exception if the arguments couldn't be parsed. */
	sipNoMethod(sipArgsParsed,sipNm_py_ivr_IvrDialog,sipNm_py_ivr_onBye);
...
static PyObject *meth_IvrDialog_onCancel(PyObject *sipSelf,PyObject *sipArgs)
{
	...
	/* Raise an exception if the arguments couldn't be parsed. */
	sipNoMethod(sipArgsParsed,sipNm_py_ivr_IvrDialog,sipNm_py_ivr_onCancel);
...
static PyObject *meth_IvrDialog_onDtmf(PyObject *sipSelf,PyObject *sipArgs)
{
	...
	/* Raise an exception if the arguments couldn't be parsed. */
	sipNoMethod(sipArgsParsed,sipNm_py_ivr_IvrDialog,sipNm_py_ivr_onDtmf);
...
static PyObject *meth_IvrDialog_onOtherBye(PyObject *sipSelf,PyObject *sipArgs)
{
	...
	/* Raise an exception if the arguments couldn't be parsed. */
	sipNoMethod(sipArgsParsed,sipNm_py_ivr_IvrDialog,sipNm_py_ivr_onOtherBye);
...
static PyObject *meth_IvrDialog_onOtherReply(PyObject *sipSelf,PyObject *sipArgs)
{
	...
	/* Raise an exception if the arguments couldn't be parsed. */
	sipNoMethod(sipArgsParsed,sipNm_py_ivr_IvrDialog,sipNm_py_ivr_onOtherReply);
...
static void *init_IvrDialog(sipWrapper *sipSelf,PyObject *sipArgs,int *)
{
	...
	if (!sipCpp)
	{
		sipNoCtor(sipArgsParsed,sipNm_py_ivr_IvrDialog);
		return 0;
	}
...
static PyObject *var_IvrDialog_dlg(PyObject *sipSelf,PyObject *valobj)
{
	...
	if (iserr)
	{
		sipBadSetType(sipNm_py_ivr_IvrDialog,sipNm_py_ivr_dlg);
		return NULL;
	}
...
PyMethodDef variables_IvrDialog[] = {
	{sipNm_py_ivr_dlg, var_IvrDialog_dlg, 0, NULL},
	{0, 0, 0, 0}
};
...
static void *forceConvertTo_IvrDialog(PyObject *valobj,int *iserrp)
{
	...
	sipBadClass(sipNm_py_ivr_IvrDialog);
...
static PyMethodDef methods_IvrDialog[] = {
	{sipNm_py_ivr_acceptAudio, meth_IvrDialog_acceptAudio, METH_VARARGS, NULL},
	{sipNm_py_ivr_onBye, meth_IvrDialog_onBye, METH_VARARGS, NULL},
	{sipNm_py_ivr_onCancel, meth_IvrDialog_onCancel, METH_VARARGS, NULL},
	{sipNm_py_ivr_onDtmf, meth_IvrDialog_onDtmf, METH_VARARGS, NULL},
	{sipNm_py_ivr_onInvite, meth_IvrDialog_onInvite, METH_VARARGS, NULL},
	{sipNm_py_ivr_onOtherBye, meth_IvrDialog_onOtherBye, METH_VARARGS, NULL},
	{sipNm_py_ivr_onOtherReply, meth_IvrDialog_onOtherReply, METH_VARARGS, NULL},
	{sipNm_py_ivr_onSessionStart, meth_IvrDialog_onSessionStart, METH_VARARGS, NULL},
	{sipNm_py_ivr_setStopped, meth_IvrDialog_setStopped, METH_VARARGS, NULL}
};
